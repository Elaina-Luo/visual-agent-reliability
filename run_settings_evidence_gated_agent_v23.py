...
def run_episode(
    ...
    return run_episode_v21(
        ...
        max_invalid_replans,
        output_root,
        strategy="evidence_gated_recovery_v2_3",
        output_subdir="settings_evidence_gated_agent_v23",
        action_aware_recovery=True,
        repair_redundant_coordinates=True,
    )
...
def main():
    ...
    print("Strategy: evidence-gated recovery v2.3")
